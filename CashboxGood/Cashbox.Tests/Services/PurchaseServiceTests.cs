...
namespace Cashbox.Tests.Services
{
    ...
    public class PurchaseServiceTests
    {
        ...
        [Test]
        public void GetDiscount_When_account_has_enough_orders_and_selected_expensive_product_Then_orders_history_discount()
        {
            // Arrange
            var service = new PurchaseService(_fakeUnitOfWorkFactory);
        ...
        [Test]
        public void Purchase_When_purchase_products_Then_account_balance_correctly_updated()
        {
            // Arrange
            var product1 = new Product { Id = 1, Price = 1, Amount = 5 };
            var product2 = new Product { Id = 2, Price = 2, Amount = 10 };
        ...
        public void Purchase_When_purchase_products_with_amount_zero_Then_throws_exception()
        {
            // Arrange
